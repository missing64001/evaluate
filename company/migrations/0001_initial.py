    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.BigIntegerField(blank=True, null=True, verbose_name='企业手机')),
                ('business_license_pic', models.ImageField(blank=True, null=True, upload_to='static/upload/company')),
                ('incubator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='incubator.Incubator', verbose_name='孵化器')),
